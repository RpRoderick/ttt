...
/***/ function(module, exports, __webpack_require__) {
	...
	var backEndEvents = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onTileClick = function onTileClick() {
	  ...
	  var i = +tile.replace(/\D/g, ''); //chrome doesn't like this line, not sure why
	  world.ttt.index = i;
	...
	var onResetBoard = function onResetBoard() {
	  world.ttt.index = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdateGame = function onUpdateGame() {
	  ...
	  api.updateGame(data).then(ui.success).catch(ui.failure);
	};
